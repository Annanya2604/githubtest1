 ...
 <header class="bg-dark py-5" id="main-header">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">WELCOME TO ONLINE BOOK STORE</h1>
            <p class="lead fw-normal text-white-50 mb-0">Here you can find your favourite books and order them!</p>
        </div>
    </div>
</header>
<!-- Section-->
